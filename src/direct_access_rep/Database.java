...
public class Database extends Records {
    ...
    public void insertRecord(Records record) throws IOException {
        if (record.getID() < 1) {
    ...
    public void updateRecord(Records record) throws IOException {
        if (record.getID() < 1) {
    ...
    public void deleteRecord(Records record) throws IllegalArgumentException, IOException {
        long position = (record.getID() - 1) * Records.INTEGER_SIZE;
        if (position >= file.length()) {
	...
	public void showAllRecords() {
	    try {
	        ...
	        int totalRecords = (int) (fileSize / Records.INTEGER_SIZE);
